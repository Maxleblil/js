...
function modifyArray(array) {
  ...
  // У випадку повного видалиння елементу
  // array.splice(2, 1);
  // const result = array.toString();
  // console.log(result);

  // Видалення з залишенням порожнього місця
  delete array[2];
  const result = array.toString();
  console.log(result);
}
...
function printStrings(array) {
  ...
  const result = array.toString().repeat(2);
  console.log(result);
}
...
function concatenateStrings(array, subString) {
  ...
  const result = array.toString().includes(subString);
  console.log(result);
  return result;
}
