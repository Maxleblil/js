...
function isAlmostSame(num1, num2) {
  ...
  const analysis = Math.abs(num1 - num2);

  if (analysis <= Number.EPSILON) {
    return true;
  } else {
    return false;
  }
...
function convertToExponential(num) {
  ...
  // Скорочений варіант без використання function
  // const convertToExponential = (num) => num.toExponential();
}
