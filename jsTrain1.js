...
console.log("calculateSum(15)", calculateSum(5)); // Виведе: 15
console.log("calculateSum(55)", calculateSum(10)); // Виведе: 55
...
function checkDataType(value) {
  ...
  console.log(`Значення ${value} має значення ${type}`);
  return type;
}
